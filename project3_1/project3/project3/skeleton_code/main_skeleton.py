...
##### fill in here #####
# model.load_state_dict(torch.load("../trained_model/resnet_encoder_unet.pth", map_location=torch.device('cpu')))
model.load_state_dict(torch.load("../trained_model/UNet_trained_model.pth", map_location=torch.device('cpu')))
